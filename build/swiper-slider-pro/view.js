...
document.querySelectorAll(".creative-conference__slider").forEach(slider => {
  ...
  function runSlideAnimation(scope) {
    const active = scope.querySelector(".swiper-slide-active .creative-conference__wrapper");
    if (!active) return;
    ...
    tl.from(active.querySelectorAll(".speaker__img, .speaker__name, .speaker__desp, .creative-conference__datetime"), {
      opacity: 0,
      y: 10,
      duration: 0.6,
      stagger: 0.2,
