...
function CounterFrontend() {
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(swiper_react__WEBPACK_IMPORTED_MODULE_1__.Swiper, {
    className: "mySwiper",
    style: {
      width: "100%",
      height: "300px"
    ...
    navigation: true,
    children: slides.map((text, index) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(swiper_react__WEBPACK_IMPORTED_MODULE_1__.SwiperSlide, {
...
document.addEventListener("DOMContentLoaded", () => {
  const containers = document.querySelectorAll(".wp-block-create-block-swiper-slider");
  containers.forEach(container => {
    const root = createRoot(container);
    root.render(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(CounterFrontend, {}));
  });
});
})();
